...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="" class="brand-link">
        <img src="{{ asset('storage/dashboard_images/AdminLTELogo.png') }}" alt="AdminLTE Logo"
    ...
    <div class="sidebar">
        <div>
            ...
            <div class="pb-3 mt-3 mb-3 user-panel d-flex">
                ...
                <div class="info">
                    <a href="#" class="d-block">مدیر سایت</a>
                </div>
            </div>
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('indexPage') }}"
                                    class="nav-link @if(last(request()->segments())== 'indexPage'){{ 'active' }} @endif">
