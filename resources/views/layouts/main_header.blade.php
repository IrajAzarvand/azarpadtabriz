<head>
    <title>Agency Fluid - Berserk HTML</title>
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" id="brk-direction-bootstrap"
        @if (SiteLang()[app()->getLocale()]['rtl']) href="css/assets/bootstrap-rtl.css"
@else href="css/assets/bootstrap.css" @endif>

    <link rel="stylesheet" id="brk-direction-offsets"
        @if (SiteLang()[app()->getLocale()]['rtl']) href="css/assets/offsets-rtl.css"
@else href="css/assets/offsets.css" @endif>
    ...
    <link id="brk-css-min" rel="stylesheet"
        @if (SiteLang()[app()->getLocale()]['rtl']) href="css/assets/styles-rtl.min.css"
