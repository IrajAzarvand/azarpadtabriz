@extends('dashboard', ['Name' => 'صفحات سایت', 'Section' => 'صفحه اصلی'])
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            <div class="card">
                ...
                <div class="p-0 card-body">
                    <div class="d-md-flex">
                        <div class="flex-1 p-1" style="overflow: hidden">
                            <!-- Map will be created here -->
                            <div id="world-map-markers" style="height: 325px; overflow: hidden"></div>
                        </div>
                        <div class="pt-2 pr-4 pb-2 pl-4 card-pane-right bg-success">
                            <div class="mb-4 description-block">
                                <div class="sparkbar pad" data-color="#fff">90,70,90,70,75,80,70</div>
                                <h5 class="mt-2 description-header">8390</h5>
                                <span class="description-text">بازدیدها</span>
                            </div>
                            <!-- /.description-block -->
                            <div class="mb-4 description-block">
                                <div class="sparkbar pad" data-color="#fff">90,50,90,70,61,83,63</div>
                                <h5 class="mt-2 description-header">30%</h5>
                                <span class="description-text">ارجاعات</span>
                            </div>
                            <!-- /.description-block -->
                            <div class="description-block">
                                <div class="sparkbar pad" data-color="#fff">90,50,90,70,61,83,63</div>
                                <h5 class="mt-2 description-header">70%</h5>
                            ...
                            <div class="direct-chat-messages">
                                ...
                                <div class="direct-chat-msg">
                                    <div class="direct-chat-info clearfix">
                                        <span class="float-left direct-chat-name">حسام موسوی</span>
                                ...
                                <div class="direct-chat-msg right">
                                    <div class="direct-chat-info clearfix">
                                        <span class="float-right direct-chat-name">سارا</span>
                        ...
                        <div class="p-0 card-body">
                            <ul class="users-list clearfix">
                                <li>
                                    ...
                                    <a class="mt-2 users-list-name" href="#">حسام موسوی</a>
                                    <span class="users-list-date">امروز</span>
                                </li>
                                <li>
                                    <img src="dist/img/user8-128x128.jpg" alt="User Image">
                                    <a class="mt-2 users-list-name" href="#">ایمان</a>
                                    <span class="users-list-date">دیروز</span>
                                </li>
                                <li>
                                    <img src="dist/img/user7-128x128.jpg" alt="User Image">
                                    <a class="mt-2 users-list-name" href="#">فاطمه</a>
                                    <span class="users-list-date">۱۷ اسفند</span>
                                </li>
                                <li>
                                    <img src="dist/img/user6-128x128.jpg" alt="User Image">
                                    <a class="mt-2 users-list-name" href="#">جان</a>
                                    <span class="users-list-date">۱۴ اسفند</span>
                                </li>
                                <li>
                                    <img src="dist/img/user2-160x160.jpg" alt="User Image">
                                    <a class="mt-2 users-list-name" href="#">محمد</a>
                                    <span class="users-list-date">۱۲ دی</span>
                                </li>
                                <li>
                                    <img src="dist/img/user5-128x128.jpg" alt="User Image">
                                    <a class="mt-2 users-list-name" href="#">سارا</a>
                                    <span class="users-list-date">۱۲ دی</span>
                                </li>
                                <li>
                                    <img src="dist/img/user4-128x128.jpg" alt="User Image">
                                    <a class="mt-2 users-list-name" href="#">مریم</a>
                                    <span class="users-list-date">۱۲ دی</span>
                                </li>
                                <li>
                                    <img src="dist/img/user3-128x128.jpg" alt="User Image">
                                    <a class="mt-2 users-list-name" href="#">نادیا</a>
            ...
            <div class="card">
                ...
                <div class="card-footer clearfix">
                    <a href="javascript:void(0)" class="float-left btn btn-sm btn-info">سفارش جدید</a>
                    <a href="javascript:void(0)" class="float-right btn btn-sm btn-secondary">مشاهده
                        همه
                        سفار</a>
                </div>
                <!-- /.card-footer -->
        ...
        <div class="col-md-4">
                        ...
                        <li class="nav-item">
                            <a href="#" class="nav-link">
                                ...
                                <span class="float-left text-success">
                                    <i class="text-sm fa fa-arrow-up"></i> 4%
                                </span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="#" class="nav-link">
                                ...
                                <span class="float-left text-warning">
                                    <i class="text-sm fa fa-arrow-left"></i> 0%
                                </span>
                            </a>
                        </li>
                    </ul>
            ...
            <div class="card">
                ...
                <!-- /.card-header -->
                <div class="p-0 card-body">
                    <ul class="pr-2 pl-2 products-list product-list-in-card">
                        <li class="item">
                            ...
                            <div class="product-info">
                                <a href="javascript:void(0)" class="product-title">تلویزیون سامسونگ
                                    <span class="float-left badge badge-warning">تومان 1800</span></a>
                        ...
                        <li class="item">
                            ...
                            <div class="product-info">
                                <a href="javascript:void(0)" class="product-title">دوچرخه
                                    <span class="float-left badge badge-info">تومان 700</span></a>
                                <span class="product-description">
                        ...
                        <li class="item">
                            ...
                            <div class="product-info">
                                <a href="javascript:void(0)" class="product-title">
                                    ایکس‌ باکس <span class="float-left badge badge-danger">
                                        تومان 350
                                    </span>
                                </a>
                                <span class="product-description">
                        ...
                        <li class="item">
                            ...
                            <div class="product-info">
                                <a href="javascript:void(0)" class="product-title">پلی استیشن 4
                                    <span class="float-left badge badge-success">$399</span></a>
                                <span class="product-description">
